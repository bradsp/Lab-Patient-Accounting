...
namespace MCL
{
    ...
    /// 
    /// </summary>
    public class R_vw_prg_chrgs_by_client_service_date : RCRecordset
    {
        ...
        public R_vw_prg_chrgs_by_client_service_date(string strServer, string strDataBase, ref ERR errLog)
            : base(strServer, strDataBase, "vw_prg_chrgs_by_client_service_date", ref errLog)
        {
        ...
        public bool LoadMemberVariablesFromDataSet()
        {
            ...
            if (m_CurrentRecordIndex > -1) //don't attempt to load if there are no records
            {
                ...
                m_strCdmDesc = m_DataSet.Tables[propTable.ToString()].Rows[m_CurrentRecordIndex]["descript"].ToString();
                ...
                m_strCdmCount = m_DataSet.Tables[propTable.ToString()].Rows[m_CurrentRecordIndex]["cdm_count"].ToString();
