/*
 * R_icd9desc 04/05/2007 Rick Crone
 * 
 * Use this class to access the icd9desc table of the MCL database. 
 * 
...
namespace MCL
{
    ...
    /// Recordset class 
    /// </summary>
    public class R_icd9desc : RCRecordset
    {
        //===== string variables for fields in record  =====
        /// <summary>
        /// Icd9 number
        /// </summary>
        public string m_strIcd9_num;
        /// <summary>
        /// Icd9 desc
        /// </summary>
        public string m_strIcd9_desc;
        /// <summary>
        /// AmaYear for icd9
        /// </summary>
        public string m_strAMA_year;
        ...
        public R_icd9desc(string strServer, string strDataBase, ref ERR errLog)
            : base(strServer, strDataBase, "icd9desc", ref errLog)
        {
        ...
        public bool LoadMemberVariablesFromDataSet()
        {
            ...
            if (m_CurrentRecordIndex > -1) //don't attempt to load if there are no records
            {
                ...
                m_strIcd9_num = m_DataSet.Tables[propTable.ToString()].Rows[m_CurrentRecordIndex]["icd9_num"].ToString();
                m_strIcd9_desc = m_DataSet.Tables[propTable.ToString()].Rows[m_CurrentRecordIndex]["icd9_desc"].ToString();
