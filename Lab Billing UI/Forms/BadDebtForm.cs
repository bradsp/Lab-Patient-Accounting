...
namespace LabBilling.Forms
{
    public partial class frmBadDebt : Form
    {
        ...
        private void GeneratePatientBillsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //    ds.Tables.Add(dtStmt);
            //    ds.Tables.Add(dtBMSG);
            //    ds.Tables.Add(dtAcct);
            //    ds.Tables.Add(dtAcctMsg);
            //    SqlCommand cmdClear = new SqlCommand();
            //    SqlCommand cmdHDR = new SqlCommand();
            //    SqlCommand cmdSelectAcc = new SqlCommand(
            //        "select * from dbo.patbill_acc " +
            //        "where nullif(date_sent,'') is NULL and statement_id =  CONVERT(VARCHAR(4),YEAR(GETDATE() ))+ " +
            //        " CONVERT(VARCHAR(2), GETDATE() ,101 )  ", conn);

            //    // SqlCommand cmdSeletAcct = new SqlCommand("Execute usp_prg_pat_bill_acct",conn);

            //    try
            //    {
            //        #region clear table and process header info
            //        //string strClearTable = "delete from pat_statements_cerner";
            //        //cmdClear = new SqlCommand(strClearTable, conn);
            //        //cmdClear.Connection.Open();
            //        //object oExec = cmdClear.ExecuteNonQuery();
            //        //cmdClear.Connection.Close();

            //        //string strInsertHDR =
            //        //    "INSERT INTO dbo.pat_statements_cerner " +
            //        //    "( statement_text )  " +
            //        //    "SELECT 'HDR~MCL~~MCL~MCL~'+  " +
            //        //    "CONVERT(VARCHAR,GETDATE(),112)  " +
            //        //    "+'~'+  " +
            //        //    "REPLACE(CONVERT(VARCHAR,GETDATE(),108),':','')+'~'+'T~'+'N~'+'0~0~0' "
            //        //    ;                   
            //        //cmdHDR = new SqlCommand(strInsertHDR, conn);
            //        //cmdHDR.Connection.Open();
            //        //oExec = cmdHDR.ExecuteNonQuery();
            //        //cmdHDR.Connection.Close();
            //        #endregion

            //        sda.SelectCommand = cmdSelectAcc;
            //        int nRec = sda.Fill(ds.Tables["ACCT"]);

            //        dgvAccounts.DataSource = ds.Tables["ACCT"];
            ...
            //    finally
            //    {
            //        //if (cmdClear != null && cmdClear.Connection.State == ConnectionState.Open)
            //        //{
            //        //    cmdClear.Connection.Close();
            //        //}
            //        //if (cmdHDR.Connection.State == ConnectionState.Open)
            //        //{
            //        //    cmdHDR.Connection.Close();
            //        //}
            //    }
