...
namespace LabBilling.Core.Models
{
    ...
    {
        [Category("Testing"), Description("This is a new parameter")]
        public string NewParamatertest { get; set; }
        ...
        [Category("Billing"), Description("ENABLE INSURANCE DIAGNOSIS POINTERS ")] 
        ...
        [Category("Billing"), Description("Max number of claims in a claim batch. Set to 0 for unlimited. ")] 
