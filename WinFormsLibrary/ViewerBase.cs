...
namespace Utilities
{
    ...
    public partial class ViewerBase : Form
    {
        ...
        private void tspPrintGrid_Click(object sender, EventArgs e)
        {
            ...
            ((DataGridView)m_arrSC[m_tcSelect.SelectedIndex].Panel2.Controls[0]).RowHeaderMouseDoubleClick += new System.Windows.Forms.DataGridViewCellMouseEventHandler(LaunchAcc.LaunchAcc_EventHandler);
