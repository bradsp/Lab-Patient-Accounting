CREATE TABLE [infce].[messages_inbound_webconnect] (
    ...
    [processFlag]      VARCHAR (5)   CONSTRAINT [DF_LIVE_messages_webconnect__proce__5931EE27] DEFAULT ('N') NULL,
    ...
    [DOS]              DATETIME      NULL,
    CONSTRAINT [PK_messages_inbound_webconnect] PRIMARY KEY CLUSTERED ([systemMsgId] ASC) WITH (FILLFACTOR = 90)
);
