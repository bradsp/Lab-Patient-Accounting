...
-- =============================================
CREATE FUNCTION GetPatDiagnosis_icd
(
...
AS
(
	SELECT dbo.pat.account, icd9_1, icd9_2, icd9_3, icd9_4, icd9_5, icd9_6, icd9_7, icd9_8, icd9_9
	, dbo.pat.icd_indicator
	FROM pat 
--	INNER JOIN acc ON dbo.acc.account = dbo.pat.account
	WHERE pat.account = @acc
)
INSERT INTO @Table_Var (colAccount, colDxNum, colDiagnosis)
