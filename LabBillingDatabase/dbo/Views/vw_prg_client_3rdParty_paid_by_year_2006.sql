CREATE VIEW [dbo].[vw_prg_client_3rdParty_paid_by_year_2006]
AS
...
HAVING      (DATEPART(Year, dbo.chk.date_rec) = '2006')
ORDER BY cli_name
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_prg_client_3rdParty_paid_by_year_2006';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_prg_client_3rdParty_paid_by_year_2006';
