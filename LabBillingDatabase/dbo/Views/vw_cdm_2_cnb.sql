...
SELECT     dbo.cdm.cdm, dbo.cpt4.cpt4, dbo.cdm.descript AS cdm_desc, dbo.cpt4.descript AS cpt4_desc, dbo.cdm.mtype, dbo.cdm.ctype, dbo.cdm.ztype, 
                      ...
                      dbo.cpt4.modi, dbo.cpt4.rev_code, dbo.cdm.mnem
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_cdm_2_cnb';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_cdm_2_cnb';
