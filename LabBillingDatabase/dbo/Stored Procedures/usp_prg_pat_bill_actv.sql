...
-- =============================================
CREATE	PROCEDURE [dbo].[usp_prg_pat_bill_actv] 
...
(
	SELECT TOP(100) PERCENT
		...
		,chrg.qty AS [units]
		, chrg.cdm 
		, cdm.descript AS [cdm_description]
		, '' AS [drg_code]
		...
		, chrg.calc_amt AS [activity_amount_due]
		, E.acct_dates_of_service AS [activity_date_of_service]
		, 0.00 AS [activity_patient_bal]
		, 0.00 AS [activity_ins_discount]
		, 'CHARGE' AS [activity_trans_type]
		, '' AS [activity_trans_sub_type]
		, chrg.calc_amt AS [activity_trans_amount]
...
, @batch
FROM cteActv
--where cteactv.statement_number IS null
