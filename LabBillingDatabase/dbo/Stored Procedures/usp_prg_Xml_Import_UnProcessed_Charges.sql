...
-- =============================================
CREATE PROCEDURE usp_prg_Xml_Import_UnProcessed_Charges
...
( 
	...
	,a.alias.value('(charge/billcode/text())[1]','varchar(7)') AS [cdm]
		...
		[. ="5939047" or .="5939003" or .="5939051" or .="5959041" or .="5929006" or
		 . ="5929022" or .="5849600" or .="5939033" or .="5949041" or .="5849510" ]',
		'varchar(7)') AS [cdms]
