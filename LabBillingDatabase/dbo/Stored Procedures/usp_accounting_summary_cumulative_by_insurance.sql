...
-- =============================================
CREATE PROCEDURE [dbo].[usp_accounting_summary_cumulative_by_insurance] 
...
--return
	...
	EXEC usp_prg_charges_by_Insurance @startdate, @enddate
--SELECT * FROM #icharges	
--RETURN;

INSERT INTO #ipayments
	EXEC dbo.usp_prg_amt_paid_by_insurance @startdate, @enddate
--SELECT * FROM #ipayments
--RETURN;
	

	INSERT INTO #icontractual
	EXEC dbo.usp_prg_contractual_by_insurance @startdate, @enddate
--SELECT * FROM #icontractual
--return

	INSERT INTO #iwriteoff
	EXEC dbo.usp_prg_write_off_by_insurance @startdate, @enddate
